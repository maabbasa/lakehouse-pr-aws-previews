...
2. In GitHub Desktop, select your existing `lakehouse-pr-aws-previews` repository and choose **Repository → Show in Finder**.
...
The AWS package is available at https://github.com/maabbasa/lakehouse-pr-aws-previews. These instructions apply to future local changes. Never add AWS credentials to the repository.
